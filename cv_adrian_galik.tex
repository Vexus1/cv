...
\begin{document}
    ...
    \vskip+0.4cm\begin{minipage}[t]{0.30\textwidth}
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item Biblioteki programistyczne: \raggedright \\ \textbf{NumPy, Pandas, Pygame, OpenCV, TensorFlow, Keras} 
    ...
    \begin{minipage}[t]{0.60\textwidth}
        ...
        \fontsize{10pt}{10pt} \\ \\
        Ambitny student \textbf{Matematyki Stosowanej}. Więdzę matematyczną wykorzystuje do pisania \textbf{algorytmów} oraz do obliczania zagadnień z astrofizyki.
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item Projekty programistycznie w języku \textbf{Python} tj. numerczyne rozwiązanie  \\ (bez użycia bibliotek) równania różniczkowego Friedmana określającego ewolucję wszechświata, gra 2D napisana w paradygmacie obiektowym przy użyciu biblioteki \textbf{Pygame} oraz rozwiązania zadań z kursu\\ algorytmiki ze studiów  (\textbf{github})
        \end{itemize}
        \rule{11cm}{1pt} \\ \\
